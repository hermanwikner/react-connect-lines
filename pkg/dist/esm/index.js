import {useRef as $3QrbC$useRef, useCallback as $3QrbC$useCallback, useMemo as $3QrbC$useMemo, cloneElement as $3QrbC$cloneElement, useEffect as $3QrbC$useEffect, createContext as $3QrbC$createContext, useContext as $3QrbC$useContext, useReducer as $3QrbC$useReducer, useState as $3QrbC$useState} from "react";
import {jsx as $3QrbC$jsx, jsxs as $3QrbC$jsxs} from "react/jsx-runtime";
...
function $a2c4c6a0c9fa4ad3$export$fc84c22acd302ca7() {
    const ctxVal = (0, $3QrbC$useContext)((0, $1aca609a13c53836$export$b18e34ac3520f2e5));
...
function $7d1adb4af4d4bebb$export$5c92df8ce16beba9(props) {
    ...
    const [state, dispatch] = (0, $3QrbC$useReducer)((0, $6e70dc151effd4e8$export$e1957580bb403527), {
        elements: [],
        dispatch: ()=>null
    });
    ...
    return /*#__PURE__*/ (0, $3QrbC$jsx)((0, $1aca609a13c53836$export$b18e34ac3520f2e5).Provider, {
        value: ctxVal,
        children: children
    });
}
...
function $55a3bb765175b9e2$export$59e6910693f047c2(props) {
    ...
    const { dispatch: dispatch  } = (0, $a2c4c6a0c9fa4ad3$export$fc84c22acd302ca7)();
...
function $ef1e09814851e7b4$export$790ca4df398846a2(props) {
    ...
    const grouped = elements.filter((e)=>(e?.connectWith || $ef1e09814851e7b4$var$EMPTY_ARRAY).length > 0).map((el)=>{
        ...
        const connectEls = elements.filter((c)=>connectWith?.map((a)=>a.id).includes(c.id)).map((x)=>{
            return {
                rect: (0, $cd93a345a293ccb2$export$d16800b7e59a8051)(x)?.getBoundingClientRect(),
        ...
        return {
            from: {
                rect: (0, $cd93a345a293ccb2$export$d16800b7e59a8051)(el)?.getBoundingClientRect()
            },
            to: connectEls
        };
    }).filter(Boolean);
...
function $bb14b941f7134610$var$getPosition(props) {
    ...
    const allowYConnect = from.left - $bb14b941f7134610$var$POS_OFFSET < to.right && from.right + to.width > to.right - $bb14b941f7134610$var$POS_OFFSET;
...
function $bb14b941f7134610$export$7709b8005774fb51(props) {
    ...
    const position = $bb14b941f7134610$var$getPosition({
        from: fromRect,
        to: toRect
    });
    switch(position){
...
const $70a9c9547d425b9f$var$DEFAULT_COLOR = "magenta";
const $70a9c9547d425b9f$var$EMPTY_ARRAY = [];
function $70a9c9547d425b9f$export$775ba819c8141467(props) {
    const [pointsData, setPointsData] = (0, $3QrbC$useState)($70a9c9547d425b9f$var$EMPTY_ARRAY);
   ...
   */ const colors = (0, $3QrbC$useMemo)(()=>[
    ...
    const handleCalcLines = (0, $3QrbC$useCallback)(()=>{
       ...
       *    }[]
       *  }
       */ const groupedConnections = (0, $ef1e09814851e7b4$export$790ca4df398846a2)({
                elements: elements
            });
   ...
   */ const handleStartInteracting = (0, $3QrbC$useCallback)(()=>{
    ...
    const ro = (0, $3QrbC$useMemo)(()=>new ResizeObserver(handleCalcLines), [
        handleCalcLines
    ]);
    (0, $3QrbC$useEffect)(()=>{
        elements.forEach((el)=>{
    ...
    return (0, $3QrbC$useMemo)(()=>/*#__PURE__*/ (0, $3QrbC$jsxs)("svg", {
            style: $70a9c9547d425b9f$var$SVG_STYLE,
            children: [
                colors?.map((c)=>/*#__PURE__*/ (0, $3QrbC$jsx)("defs", {
                        children: /*#__PURE__*/ (0, $3QrbC$jsx)("marker", {
                            id: `triangle-${c}`,
                            markerHeight: "5",
                            ...
                            refY: "5",
                            viewBox: "0 0 10 10",
                            children: /*#__PURE__*/ (0, $3QrbC$jsx)("path", {
                ...
                pointsData?.map((p)=>{
                    return /*#__PURE__*/ (0, $3QrbC$jsx)("path", {
                        id: "p1",
                        d: p?.d,
                        fill: "none",
...
function $c3a4d9f36d432340$var$ConnectProviderInner() {
    const { elements: elements  } = (0, $a2c4c6a0c9fa4ad3$export$fc84c22acd302ca7)();
    return /*#__PURE__*/ (0, $3QrbC$jsx)((0, $70a9c9547d425b9f$export$775ba819c8141467), {
        elements: elements
    });
}
function $c3a4d9f36d432340$export$230737e70939b618(props) {
    const { children: children  } = props;
    return /*#__PURE__*/ (0, $3QrbC$jsxs)((0, $7d1adb4af4d4bebb$export$5c92df8ce16beba9), {
        children: [
            children,
            /*#__PURE__*/ (0, $3QrbC$jsx)($c3a4d9f36d432340$var$ConnectProviderInner, {})
        ]
    });
}
...
export {$55a3bb765175b9e2$export$59e6910693f047c2 as Connect, $c3a4d9f36d432340$export$230737e70939b618 as ConnectProvider, $70a9c9547d425b9f$export$775ba819c8141467 as ConnectLines};
